---
name: metis
description: Use BEFORE planning complex or ambiguous requests to identify hidden intentions, scope ambiguities, and AI failure points. Examples: "analyze this request before we plan it", "what am I missing in this spec", "what could go wrong with this approach".
